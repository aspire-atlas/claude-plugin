...
- Every Atlas write in a skill or agent is confirmed with `AskUserQuestion` first; destructive and paid tools each get their own confirmation; unattended runs never ask, never destroy, never spend.
