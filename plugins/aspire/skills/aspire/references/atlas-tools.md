...
| Avoid in onboarding | `lookup_creators`, `lookup_posts`, `start_business_discovery`, `search_creator_marketplace`, `get_job_status` | Start discovery jobs; TikTok post lookups are paid | Only on explicit user request |
